...
$("#statusFilter").addEventListener("change", renderStudentTable);
$("#studentFormEl").addEventListener("submit", saveForm);
if ($("#loginForm")) $("#loginForm").addEventListener("submit", loginStudent);
$("#addEducationRow").addEventListener("click", () => educationRow());
